"""
Flair3D+ tile climatic-domain classification dataset (preprocessed Pointcept scenes).
...
class Flair3DClimaticDomainDataset(Dataset):
    def __init__(
        self,
        split="train",
        ...
        logger.info(
            "Totally {} x {} samples in Flair3DClimaticDomain {} set.".format(
