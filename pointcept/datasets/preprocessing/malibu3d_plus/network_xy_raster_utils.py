...
def default_missing_coord_details_csv() -> Path:
    """Repo ``data/malibu3d_plus/missing_coord_tiles.details.csv`` (same as Malibu3DDataset)."""
    # network_xy_raster_utils.py -> .../preprocessing/malibu3d_plus -> repo root = parents[4]
    return (
