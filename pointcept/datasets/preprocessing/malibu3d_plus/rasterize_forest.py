...
python pointcept/datasets/preprocessing/malibu3d_plus/rasterize_forest.py \
    --data_root data/malibu3d_plus \
    --source_dataset_root data/malibu3d_plus/raw \
...
try:
    ...
    from pointcept.datasets.preprocessing.malibu3d_plus.preprocess_malibu3d_v2 import (
