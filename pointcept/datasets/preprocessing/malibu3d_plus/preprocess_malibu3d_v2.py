...
The split manifest CSV (e.g. ``data/malibu3d_plus/raw/scene_split_manifest.csv``)
...
Conventions (must match scripts/build_csv_manifest.py):
    ...
    PLY path = {ply_root}/LIDARHD/{dept_year}_LIDARHD/{roi}/
               {dept_year}_LIDARHD_{roi}_{scene_i_j}.plydata/malibu3d_plus/raw/scene_split_manifest_D075.csv
...
python pointcept/datasets/preprocessing/malibu3d_plus/preprocess_malibu3d_v2.py \
    --output_root data/malibu3d_plus \
    --split_manifest_csv data/malibu3d_plus/raw/scene_split_manifest.csv \
    --num_workers 24 \
    --multilabel-only
