"""
Unzip Malibu3D+ archives into a standardized raw directory tree.
...
Example:
python pointcept/datasets/preprocessing/malibu3d_plus/unzip_malibu3d.py \
    --source_root data/malibu3d_plus/malibu3d_plus_067 \ 
    --target_root data/malibu3d_plus/raw \
    --workers 8
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Extract Malibu3D+ zip archives into a raw folder layout."
    )
    parser.add_argument(
        "--source_root",
        type=Path,
