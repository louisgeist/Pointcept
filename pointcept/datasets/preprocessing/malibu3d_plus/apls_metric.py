...
try:
    ...
    from pointcept.datasets.preprocessing.malibu3d_plus import (  # type: ignore
        network_xy_raster_utils as xy_rast,
    )
    from pointcept.datasets.preprocessing.malibu3d_plus.network_label_utils import (  # type: ignore
        LoadedNetworkGraph,
    )
