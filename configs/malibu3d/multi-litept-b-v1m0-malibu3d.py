"""
LitePT-Base on Malibu3D multitask: segment (v20) + forest_2d + elevation + 4
...
Same multitask wiring as multi-litept-v1m0-malibu3d.py (LitePT-Small) but with
LitePT-v1 Base backbone dims.
...
# Wandb parameters
wandb_run_name = (
    f"LPT-B multi {grp_exp}.{num_exp}) iter={total_iters}"
)
