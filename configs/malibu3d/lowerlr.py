...
# scheduler settings
epoch = 3000
optimizer = dict(type="AdamW", lr=0.003, weight_decay=0.05)  # lr / 2 vs base
scheduler = dict(
    type="OneCycleLR",
    max_lr=[0.003, 0.0003],  # max_lr / 2 vs base
    pct_start=0.05,
    anneal_strategy="cos",
    div_factor=10.0,
    final_div_factor=1000.0,
)
param_dicts = [dict(keyword="block", lr=0.0003)]  # block lr / 2 vs base
