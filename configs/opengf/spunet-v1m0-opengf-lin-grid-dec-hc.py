"""
SpUNet-v1m1 grid-search linear probing on OpenGF — decoder hypercolumn /
multi-scale variant (same frozen checkpoint as
spunet-v1m0-opengf-lin-grid-{enc,dec,enc-dec}.py, job 1052217, Flair3D+ multitask
...
decoder (spunet-v1m0-opengf-lin-grid-dec.py, 96ch), encoder-only
(spunet-v1m0-opengf-lin-grid-enc.py, 512ch), and combined enc+dec
(spunet-v1m0-opengf-lin-grid-enc-dec.py, 1088ch). See
...
wandb_run_name = (
    f"SpUNet GridProbe OpenGF {grp_exp}.{num_exp}) decoder hypercolumn {backbone_out_channels}ch, "
