...
trained from scratch -- from-scratch baseline counterpart to the GridProbe
(frozen-backbone linear-probe) configs, mirroring
...
# Wandb parameters
wandb_run_name = f"OpenGF LitePT-B semseg ({grp_exp}.{num_exp}) lr={lr}"
