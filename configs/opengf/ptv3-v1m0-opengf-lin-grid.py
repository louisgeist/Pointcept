"""
PT-v3-malibu grid-search linear probing on OpenGF — decoder hypercolumn /
...
Unlike the DALES sibling's own reference, w109/4/ptv3_lin/ptv3-v1m0-dales-lin_1.py
(finest decoder stage only, 64ch), this config sets `traceable=True` so
GridProbeSegmentorV2 concatenates every decoder-stage feature + the encoder
bottleneck into one 1024-dim vector per point (64+64+128+256 + 512). Same
...
wandb_run_name = (
    f"PT-v3-malibu GridProbe OpenGF {grp_exp}.{num_exp}) decoder hypercolumn 1024ch, "
