"""
LitePT-Base grid-search linear probing on OpenGF — decoder hypercolumn /
multi-scale variant (transfer from Flair3D+ multitask supervised
pretrain, job 873542).

Same multi-scale mechanism as the DALES sibling's own reference,
w109/3/dales_lin/litept-b-v1m0-dales-lin_5.py
...
variant see (DALES) w109/4/grid_12h/litept-b-v1m0-dales-lin_1.py.
...
wandb_run_name = (
    f"LitePT-B GridProbe OpenGF {grp_exp}.{num_exp}) decoder hypercolumn 1404ch, "
