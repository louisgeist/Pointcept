"""
SpUNet-v1m1 grid-search linear probing on OpenGF — decoder (standard U-Net
...
from. See spunet-v1m0-opengf-lin-grid-enc.py for the encoder-multiscale
...
wandb_run_name = (
    f"SpUNet GridProbe OpenGF {grp_exp}.{num_exp}) decoder {backbone_out_channels}ch, "
