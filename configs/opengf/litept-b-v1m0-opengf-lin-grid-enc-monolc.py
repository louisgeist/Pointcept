...
Frozen backbone: Flair3D+ mono-task land-cover (segment v20) only
(job 1293025). Standalone copy of litept-b-v1m0-opengf-lin-grid-enc.py with
only the checkpoint swapped (same recipe as the H3D monoLC ablation).
...
wandb_run_name = (
    f"LitePT-B GridProbe OpenGF {grp_exp}.{num_exp}) enc monoLC job1293025, "
