...
(Chen et al. 2018, job 1468317). Standalone copy of
litept-b-v1m0-opengf-lin-grid-enc.py with only the checkpoint swapped.
...
wandb_run_name = (
    f"LitePT-B GridProbe OpenGF {grp_exp}.{num_exp}) enc realGN job1468317, "
