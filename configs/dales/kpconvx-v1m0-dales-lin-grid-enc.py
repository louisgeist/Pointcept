"""
KPConvX DALES linear probe, encoder-multiscale (`enc_mode=True`).
Frozen Malibu3D multitask backbone; drop_path_rate=0; same probe grid as other DALES lin-grid configs.
"""
...
wandb_run_name = (
    f"KPConvX GridProbe DALES {grp_exp}.{num_exp}) encoder multiscale {backbone_out_channels}ch, "
