"""
Sonata-v1m1 grid-search linear probing on DALES (coord scale 1/50) — official indoor release baseline
...
strength channel). Scene coords are rescaled by 1/50 before GridSample; grid_size=0.02 (native indoor Sonata pretrain).
...
ignore_index = 8
grid_size = 0.02
coord_scale = 1 / 50  # aerial coord rescale; grid_size stays at native indoor 0.02
point_max = 102400
...
wandb_run_name = (
    f"Sonata-v1m1 indoor GridProbe DALES {grp_exp}.{num_exp}) HF pretrain, "
