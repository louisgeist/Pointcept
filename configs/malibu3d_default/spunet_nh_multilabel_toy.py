"""
Toy SpUNet config for debugging on local machine (D067 subset).
...
grad_norm_amp_probe_scale = 1024 # by default anyway
...
# Stratified fixed val/test subset (see README_MALIBU3D.md "Fast dev val/test")
val_stratified_subset_manifest = None
# val_stratified_subset_manifest = "data/malibu3d_plus/manifests/val_dev_subset_100.csv"
...
# Wandb parameters
wandb_run_name = (
    f"mean_pool with amp_probe_scale={grad_norm_amp_probe_scale}"
)
