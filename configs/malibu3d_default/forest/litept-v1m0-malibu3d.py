"""
LitePT-v1 on Malibu3D+ (coord + RGB + strength in feat_keys).

Mono-task Malibu3D+ config for target ``forest``. Inherits only from default_runtime.
"""
...
# Wandb parameters
wandb_run_name = (
    f"LPT-S forest {grp_exp}.{num_exp}) iter={total_iters}"
)
wandb_project = "malibu3d_forest"
