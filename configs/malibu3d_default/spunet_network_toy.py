"""
Toy SpUNet config for debugging network pixel segmentation on local machine (D067).
...
Example::
    ...
    python tools/train.py --config-file configs/malibu3d_default/spunet_network_toy.py \\
      --num-gpus 1
"""
...
wandb_project = "malibu3d_network"
