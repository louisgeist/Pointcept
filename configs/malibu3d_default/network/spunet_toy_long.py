"""
SpUNet longer toy overfit for network pixel segmentation on local machine (D067).
...
Example::
    ...
    python tools/train.py --config-file configs/malibu3d_default/network/spunet_toy_long.py \\
      --num-gpus 1
"""
