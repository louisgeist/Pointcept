"""
Sonata-v1m1 grid-search linear probing on H3D — official indoor release baseline
...
are rescaled by 1/25 before GridSample; grid_size=0.02 (native indoor Sonata pretrain).
