...
wandb_run_name = (
    f"Sonata SeedEnsemble H3D {grp_exp}.{num_exp}) epoch_120, enc multiscale {backbone_out_channels}ch, "
    f"AdamW/wd0/OneCycleLR warmup0%, {len(probes)} inits, lr=0.02, epoch={epoch}"
)
