...
wandb_run_name = (
    f"PT-v3-malibu SeedEnsemble ECLAIR {grp_exp}.{num_exp}) enc multiscale {backbone_out_channels}ch, "
    f"AdamW/wd0/OneCycleLR warmup5%, {len(probes)} inits, lr=0.002, epoch={epoch}"
)
