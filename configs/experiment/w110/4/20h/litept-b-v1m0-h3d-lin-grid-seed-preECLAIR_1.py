...
epoch = 2000
eval_epoch = 10
lr = 0.01  # re-run at 1e-2 (sweep winner was 5e-3)
patch_size = 1024
...
# Seed-ensemble probes — ce_lovasz, AdamW/wd0/OneCycleLR warmup5%, lr=1e-2
# (re-run; sweep winner was 5e-3); only the random init differs across
...
wandb_run_name = (
    f"LitePT-B SeedEnsemble H3D {grp_exp}.{num_exp}) enc preECLAIR job1330042, "
