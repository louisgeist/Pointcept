...
Frozen backbone: Flair3D+ mono elevation supervised pretrain
(job 1293002, w109/7/abla_mono_lr5e-4, lr=5e-4). Standalone copy of
configs/eclair/litept-b-v1m0-eclair-lin_enc.py with only the checkpoint swapped.
...
weight = "/lustre/fswork/projects/rech/unv/usi32yh/Pointcept/logs/slurm/1293002/model/model_best.pth"
...
wandb_run_name = (
    f"LitePT-B GridProbe ECLAIR {grp_exp}.{num_exp}) enc monoElev job1293002, "
