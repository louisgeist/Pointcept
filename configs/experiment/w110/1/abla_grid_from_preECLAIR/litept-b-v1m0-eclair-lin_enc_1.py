...
Frozen backbone: supervised ECLAIR from-scratch (job 1330042,
w110/1/abla1_preECLAIR). Standalone copy of
configs/experiment/w110/1/abla_grid_on_eclair/litept-b-v1m0-eclair-lin_enc_1.py
with only the checkpoint swapped.

`enc_mode=True` → 1386ch concat of the 5 raw encoder stages
(54+108+216+432+576). Grid (12 probes): ce_lovasz, AdamW/wd0/OneCycleLR
warmup5%, lr sweep {1e-4 … 5e-1}. epoch=200 / eval_epoch=10. AMP enabled
(fp16). skip_test=False. ECLAIR RGB + strength_feat_scale=1/60000 unchanged
from the reference.
"""
...
weight = "/lustre/fswork/projects/rech/unv/usi32yh/Pointcept/logs/slurm/1330042/model_best.pth"
...
wandb_run_name = (
    f"LitePT-B GridProbe ECLAIR {grp_exp}.{num_exp}) enc preECLAIR job1330042, "
