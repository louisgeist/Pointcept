...
configs/experiment/w110/1/abla_grid_on_dales/litept-b-v1m0-dales-lin-grid-enc_1.py
...
warmup5%, lr sweep {1e-4 … 5e-1}. epoch=400 / eval_epoch=10. AMP enabled
...
wandb_run_name = (
    f"LitePT-B GridProbe DALES {grp_exp}.{num_exp}) enc preECLAIR job1330042, "
