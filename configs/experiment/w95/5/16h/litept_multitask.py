...
batch_size_val = batch_size_per_gpu * num_gpu // 2
batch_size_test = batch_size_per_gpu * num_gpu // 2 
...
task_criteria["elevation"] = [
    dict(type="SmoothL1Loss", beta=1e-2, loss_weight=1.0),
]
...
hooks = [
    ...
    dict(type="InformationWriter", log_interval=100, write_cls_iou=True),
