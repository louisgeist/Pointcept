...
Mono-task ablation for point-wise elevation regression (meters). Standalone
copy of flair3d_default/elevation/litept-b-v1m0-flair3d.py (Base backbone +
schedule from multi-litept-b). Inherits only from default_runtime.
"""
