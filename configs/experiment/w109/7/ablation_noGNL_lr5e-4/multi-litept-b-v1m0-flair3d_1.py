...
Standalone copy for w109/5/ablation; inherits only from default_runtime.
"""
...
# Hardware parameters
num_gpu = 4
num_worker = 16 * num_gpu # H100: fixed 16 DataLoader workers (total, not 8 * num_gpu)
sync_bn = True
enable_amp = True
...
# Wandb parameters
wandb_run_name = (
    f"4xH100 LPT-B multi noGNL {grp_exp}.{num_exp}) iter={total_iters}, lr={lr}"
)
