...
(same frozen checkpoint as spunet-v1m0-h3d-lin-grid-dec.py, job 1052217,
...
Same probe grid as configs/h3d/litept-b-v1m0-h3d-lin_enc.py (SGD/wd0/CosineAnnealingLR,
lr sweep over 12 values, epoch=2000/eval_epoch=10) for
...
wandb_run_name = (
    f"SpUNet GridProbe H3D {grp_exp}.{num_exp}) enc multiscale {backbone_out_channels}ch, "
