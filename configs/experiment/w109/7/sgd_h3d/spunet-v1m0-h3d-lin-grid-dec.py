...
Same probe grid as configs/h3d/litept-b-v1m0-h3d-lin_dec.py (SGD/wd0/CosineAnnealingLR,
...
wandb_run_name = (
    f"SpUNet GridProbe H3D {grp_exp}.{num_exp}) decoder {backbone_out_channels}ch, "
