"""
Sonata-v1m2 grid-search linear probing on DALES — Z_MinShift variant of
w109/5/grid_dales_19h/sonata-v1m2-dales-lin-grid_3.py (same frozen checkpoint,
job 862680, epoch_120). Frozen PT-v3m2 encoder (enc_mode=True -> multi-scale
concat 1232ch = 48+96+192+384+512). No coord_feat_scale; zero color fill via
FillMissingFeat; strength_feat_scale=1/60000 (DALES raw intensity).
