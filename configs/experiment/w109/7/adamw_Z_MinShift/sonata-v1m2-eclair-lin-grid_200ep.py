...
w109/6/3_grid_eclair/sonata-v1m2-eclair-lin-grid_200ep.py (same frozen
...
wandb_run_name = (
    f"Sonata GridProbe ECLAIR {grp_exp}.{num_exp}) epoch_120, enc multiscale 1232ch H100 ep200, "
