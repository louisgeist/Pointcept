...
input_norm=None x optimizer=SGD x no warmup. epoch=200 / eval_epoch=10.
"""
...
wandb_run_name = (
    f"LitePT-B GridProbe ECLAIR {grp_exp}.{num_exp}) enc multiscale {backbone_out_channels}ch, "
