"""
Sonata-v1m2 grid-search linear probing on H3D — shorter schedule variant of
w109/6/grid_h3d/sonata-v1m2-h3d-lin-grid.py (same frozen checkpoint as
...
Dataset-driven axes (num_worker/AMP/batch) match 11h_grid_h3d. epoch=1000
/ eval_epoch=10 (half the 2000ep grid_h3d schedule).
