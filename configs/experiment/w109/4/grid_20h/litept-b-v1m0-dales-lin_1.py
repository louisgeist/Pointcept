...
H100 rerun of w109/4/grid_19h/litept-b-v1m0-dales-lin_1.py: lower/finer lr
...
# lr=2e-2 / wd=5e-3 / warmup=5% — ablates whether normalizing the 1404ch
# hypercolumn before the linear probe corrects the cross-stage scale
# heterogeneity between the finest decoder stage and the bottleneck.
