...
input_norm=None x AdamW x warmup=5%. epoch=100 / eval_epoch=10 (2x ablation).
...
wandb_run_name = (
    f"Sonata GridProbe ECLAIR {grp_exp}.{num_exp}) epoch_120, enc multiscale 1232ch H100 ep100, "
