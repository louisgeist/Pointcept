...
litept-b-v1m0-eclair-lin_1.py in this directory (same probe grid).
...
input_norm=None x AdamW x warmup=5%. epoch=100 / eval_epoch=10.
GT-only train ablation (include_pseudo=False).
...
wandb_run_name = (
    f"Sonata GridProbe ECLAIR {grp_exp}.{num_exp}) epoch_120, enc multiscale 1232ch H100 GT-only, "
