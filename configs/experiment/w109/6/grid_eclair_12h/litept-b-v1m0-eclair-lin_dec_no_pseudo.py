...
like DALES. Experiment copy of configs/eclair/litept-b-v1m0-eclair-lin-grid.py
for Jean-Zay H100 (num_worker=24).
...
wandb_run_name = (
    f"LitePT-B GridProbe ECLAIR {grp_exp}.{num_exp}) decoder hypercolumn 1404ch H100 GT-only, "
