...
_2: same as flair3d_default/multi-kpconvx-v1m0-flair3d.py with batch_size=4,
radius_scaling=3.0 (larger inter-stage zoom), H100.
...
# Wandb parameters
wandb_run_name = (
    f"H100 KPConvX multi {grp_exp}.{num_exp} iters={total_iters} bs={batch_size} rs={radius_scaling}"
)
