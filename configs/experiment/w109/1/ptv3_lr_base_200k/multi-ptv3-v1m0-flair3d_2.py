...
_2: same as flair3d_default/multi-ptv3-v1m0-flair3d.py with total_iters=200_000,
lr=2e-3 (w108/5/lr2e-3), H100.
...
# Wandb parameters
wandb_run_name = (
    f"H100 ptv3 multi {grp_exp}.{num_exp} iters={total_iters} lr={lr}"
)
