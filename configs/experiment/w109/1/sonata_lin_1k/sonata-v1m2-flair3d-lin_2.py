...
Checkpoint (pretrain job 862680, epoch 150):
  /lustre/fsn1/projects/rech/unv/usi32yh/logs/pointcept_logs/slurm/862680/model/epoch_150.pth
...
wandb_run_name = (
    ...
    f"ep150 | bs={batch_size} | iters={total_iters}"
)
