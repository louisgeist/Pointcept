...
# Sonata pretrain ckpt (job 862680, epoch 76) — remap via CheckpointLoader
weight = "/lustre/fsn1/projects/rech/unv/usi32yh/logs/pointcept_logs/slurm/862680/model/epoch_76.pth"
...
wandb_run_name = (
    ...
    f"ep76 | bs={batch_size} | iters={total_iters}"
)
