...
weight = "/lustre/fswork/projects/rech/unv/usi32yh/Pointcept/logs/slurm/2145547/model/model_best.pth"

wandb_run_name = f"SpUNet FT {grp_exp}.{num_exp}) lr={lr}, epoch={epoch}, bs={batch_size}"
...
model = dict(
    ...
    backbone=dict(
        type="SpUNet-v1m1",
        in_channels=7, #Coords + strength + fake color
...
hooks = [
    dict(type="CheckpointLoader", exclude_keys=("final",)),
    dict(type="ModelHook"),
