...
weight = "/lustre/fswork/projects/rech/unv/usi32yh/Pointcept/logs/slurm/2145539/model/model_best.pth"
...
model = dict(
    ...
    backbone=dict(
    type="LitePT-v1",
        in_channels=4, # strength + fake color
...
scheduler = dict(
    type="OneCycleLR",
    max_lr=[lr, lr/10, lr*lr_head_scale],
    pct_start=0.05,
    anneal_strategy="cos",
    div_factor=10.0,
...
param_dicts = [dict(keyword="block", lr=lr/10),
               dict(keyword="seg_head", lr=lr*lr_head_scale)]
