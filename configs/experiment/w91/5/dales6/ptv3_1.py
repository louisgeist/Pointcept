...
weight = "/lustre/fswork/projects/rech/unv/usi32yh/Pointcept/logs/slurm/2145544/model/model_best.pth"

wandb_run_name = f"PTv3 FT. {grp_exp}.{num_exp}) lr={lr}, epoch={epoch}, bs={batch_size}"
