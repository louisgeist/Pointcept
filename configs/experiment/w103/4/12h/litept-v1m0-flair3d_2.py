...
natural_habitat_multilabel uses attention scene pooling (ablation vs default mean).
...
wandb_run_name = (
    ...
    f"({grp_exp}.{num_exp}) lr={lr}, mix_prob={mix_prob}, nh_pool=attention | LOG GRAD"
)
...
task_configs["natural_habitat_multilabel"]["pooling"] = "attention"
