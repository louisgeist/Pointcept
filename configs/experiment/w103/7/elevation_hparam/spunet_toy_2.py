"""
Toy SpUNet elevation hparam ablation (warmup_50).

warmup_iters=50. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.2) | warmup_50"
)
