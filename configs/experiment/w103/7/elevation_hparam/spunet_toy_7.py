"""
Toy SpUNet elevation hparam ablation (weight_decay_0).

weight_decay=0. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.7) | weight_decay_0"
)
