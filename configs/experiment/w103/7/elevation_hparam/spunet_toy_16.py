"""
Toy SpUNet elevation hparam ablation (smoothl1_beta_1.0).

SmoothL1 beta=1.0. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.16) | smoothl1_beta_1.0"
)
