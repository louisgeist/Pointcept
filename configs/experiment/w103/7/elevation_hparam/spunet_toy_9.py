"""
Toy SpUNet elevation hparam ablation (target_scale_0.1).

elevation_target_scale=0.1. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.9) | target_scale_0.1"
)
