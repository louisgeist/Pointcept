"""
Toy SpUNet elevation hparam ablation (long_run).

total_iters=5000, warmup=50. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.17) | long_run"
)
