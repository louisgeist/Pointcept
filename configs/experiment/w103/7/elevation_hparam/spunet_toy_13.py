"""
Toy SpUNet elevation hparam ablation (coord_scale_1.0).

coord_feat_scale=1.0. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
coord_feat_scale = 1.0
feat_scales = dict(coord=coord_feat_scale)

# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.13) | coord_scale_1.0"
)
