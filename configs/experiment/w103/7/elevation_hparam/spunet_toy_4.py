"""
Toy SpUNet elevation hparam ablation (no_z_random_offset).

no Z_RandomOffset. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.4) | no_z_random_offset"
)
