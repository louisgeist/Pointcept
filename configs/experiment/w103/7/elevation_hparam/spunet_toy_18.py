"""
Toy SpUNet elevation hparam ablation (lr_5e-4).

lr=5e-4. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.18) | lr_5e-4"
)
