"""
Toy SpUNet elevation hparam ablation (lr_1e-4).

lr=1e-4. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.19) | lr_1e-4"
)
