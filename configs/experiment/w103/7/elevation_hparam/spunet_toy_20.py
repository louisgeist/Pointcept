"""
Toy SpUNet elevation hparam ablation (loss_l1).

Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.20) | loss_l1"
)
...
model = dict(
    ...
    criteria=[dict(type="L1Loss", loss_weight=1.0)],
    backbone=dict(
        type="SpUNet-v1m1",
