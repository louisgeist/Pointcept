"""
Toy SpUNet elevation hparam ablation (smoothl1_beta_0.1).

SmoothL1 beta=0.1. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.15) | smoothl1_beta_0.1"
)
...
model = dict(
    ...
    criteria=[dict(type="SmoothL1Loss", beta=0.1, loss_weight=1.0)],
    backbone=dict(
        type="SpUNet-v1m1",
