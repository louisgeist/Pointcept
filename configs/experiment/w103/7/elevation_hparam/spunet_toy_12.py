"""
Toy SpUNet elevation hparam ablation (coord_scale_0.1).

coord_feat_scale=0.1. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.12) | coord_scale_0.1"
)
