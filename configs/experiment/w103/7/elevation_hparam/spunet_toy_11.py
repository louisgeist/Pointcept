"""
Toy SpUNet elevation hparam ablation (feat_no_coord).

feat_keys without coord. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.11) | feat_no_coord"
)
...
model = dict(
    ...
    backbone=dict(
        type="SpUNet-v1m1",
        in_channels=4,  # feat_keys channels
        num_classes=0,
