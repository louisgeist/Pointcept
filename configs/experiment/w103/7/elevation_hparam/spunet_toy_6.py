"""
Toy SpUNet elevation hparam ablation (lr_1e-2).

lr=1e-2. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.6) | lr_1e-2"
)
