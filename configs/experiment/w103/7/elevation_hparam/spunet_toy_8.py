"""
Toy SpUNet elevation hparam ablation (amp_off).

enable_amp=False. Small subset (D067 manifest, max_sample caps), DefaultRegressorV2 on elevation only.
"""
...
# Wandb parameters
wandb_run_name = (
    f"SpUNet elev overfit (2.8) | amp_off"
)
