"""
PT-v3-malibu grid-search linear probing on H3D — RANDOM-INIT backbone baseline.

Encoder multiscale variant (`enc_mode=True`, 992ch). Same probe grid and data
pipeline as configs/h3d/ptv3-v1m0-h3d-lin-grid-enc.py (pretrained Flair3D+
...
wandb_run_name = (
    f"PT-v3-malibu GridProbe H3D RANDOM INIT H100 w111.2.{num_exp}) "
