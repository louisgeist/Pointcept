...
Variant _1: GradNormLite (production default). 1× A100, total_iters=20_000.
Use W&B train/s_per_epoch, val/s_per_epoch, runtime/total_s to extrapolate
full 200k-iter run duration (×10 scaling).
...
# Wandb parameters
wandb_run_name = (
    f"A100 LPT-B multi GNL w111.2.{num_exp} iters={total_iters}"
)
