"""
LitePT-Base on Flair3D+ multitask — training-time calibration (w111/2/training_time).

Variant _3: real GradNorm (Chen et al. 2018) instead of GradNormLite. 1× A100,
total_iters=20_000. Use W&B train/s_per_epoch, val/s_per_epoch, runtime/total_s
to extrapolate full 200k-iter run duration (×10 scaling).
...
# Wandb parameters
wandb_run_name = (
    f"A100 LPT-B multi realGN a{grad_norm_alpha} w111.2.{num_exp} iters={total_iters}"
)
