"""
Sonata-v1m1 grid-search linear probing on H3D — w111/3/sonata_indoor (no aerial coord rescale) — official indoor release baseline
...
use native scene coords (no FixedScaleCoord); grid_size=0.02 (native indoor Sonata pretrain).
