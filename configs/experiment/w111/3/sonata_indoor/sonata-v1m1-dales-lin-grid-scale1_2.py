"""
Sonata-v1m1 grid-search linear probing on DALES — w111/3/sonata_indoor (no aerial coord rescale) — official indoor release baseline
...
strength channel). No aerial coord rescale (native scene coords); grid_size=0.02 (native indoor Sonata pretrain).
...
wandb_run_name = (
    ...
    f"enc {backbone_out_channels}ch, coord/1, {len(probes)} probes, epoch={epoch}"
)
