"""
Sonata-v1m1 grid-search linear probing on ECLAIR — w111/3/sonata_indoor (no aerial coord rescale) — official indoor release
...
not used. No aerial coord rescale (native scene coords); grid_size=0.02 (native indoor Sonata pretrain).
...
wandb_run_name = (
    f"Sonata-v1m1 indoor w111.3 GridProbe ECLAIR {grp_exp}.{num_exp}) HF pretrain, "
