"""
Sonata-v1m1 grid-search linear probing on ECLAIR — w111/3/sonata_indoor (coord scale 1/5) — official indoor release
...
not used. Scene coords are rescaled by 1/5 before GridSample; grid_size=0.02 (native indoor Sonata pretrain).
