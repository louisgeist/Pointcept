"""
SEED-ENSEMBLE (generated from grid sweep job 1646234): 10 probes at lr=0.01 (winner='ce_lovasz_lr1e-2', select_metric=mIoU, best val=0.4370), differing only by probe-head random init. Backbone reloaded from grid job model_last.pth (same random-init draw as phase 1).
...
weight = "/lustre/fswork/projects/rech/unv/usi32yh/Pointcept/logs/slurm/1646234/model/model_last.pth"
...
wandb_run_name = (
    f"PT-v3-malibu SeedEnsemble DALES RANDOM INIT H100 w111.3.{num_exp}) "
    f"enc {backbone_out_channels}ch, {len(probes)} inits, lr=0.01, epoch={epoch}"
)
