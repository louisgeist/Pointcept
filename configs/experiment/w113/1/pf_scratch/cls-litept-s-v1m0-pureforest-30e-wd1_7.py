...
grid_size = 0.1
point_max = 102400  # aligned with Flair3D / DALES / H3D recipe
patch_size = 1024
...
# Wandb parameters
wandb_run_name = (
    f"PureForest LitePT-S classification ({grp_exp}.{num_exp}) "
    f"from-scratch lr={lr} epoch={epoch} wd={weight_decay}"
)
...
model = dict(
    ...
    backbone=dict(
        ...
        # LitePT-S dims (matches cls-litept-v1m0-pureforest.py backbone).
        stride=(2, 2, 2, 2),
