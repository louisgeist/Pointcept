...
batch_size = batch_size_per_gpu #* num_gpu -> batch_size constant of the num_gpu
...
wandb_run_name = f"KPConvX scratch {grp_exp}.{num_exp}) lr={lr}, epoch={epoch}, bs={batch_size}"
