"""
SpUNet semantic segmentation on H3D (coord + RGB point features).
...
# Wandb parameters
wandb_run_name = f"H3D SpUNet semseg ({grp_exp}.{num_exp}) lr={lr} epoch={epoch}"
