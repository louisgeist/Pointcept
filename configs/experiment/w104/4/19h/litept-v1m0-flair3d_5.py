...
wandb_run_name = (
    f"Flair3D+ LitePT "
    f"({grp_exp}.{num_exp}) lr={lr}, mix_prob={mix_prob}, nh_pool=mean, reg_loss=MSE, manual_task_weights"
)
...
task_criteria["elevation"] = [dict(type="MSELoss", loss_weight=1.0)]
task_weights = {
    "segment": 1 / 1.34,
    "forest": 1.0,
    "elevation": 1 / 1e-4,
    "natural_habitat_multilabel": 1 / 0.01,
}
