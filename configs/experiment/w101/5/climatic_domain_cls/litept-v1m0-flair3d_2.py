"""
LitePT-v1 multi-task: segment (v17) + forest + elevation + tile climatic_domain.

On-disk segment labels: preprocess --segment_definition v17.
climatic_domain.npy from --write_climatic_domain_category.
"""
...
wandb_run_name = (
    f"Flair3D+ LitePT segment v17+forest+elevation+climatic_domain "
