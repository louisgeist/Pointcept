"""
SpUNet toy debug on hecate (D067 subset).

Derived from experiment/w101/7/moisture_multi/multi-litept-v1m0-flair3d_1.py:
segment v17 + forest + natural_habitat (by_moisture on-the-fly) + elevation.

Requires D067 preprocessed data with segment v17 on disk and NH default labels.
"""
...
wandb_run_name = (
    f"[debug/hecate/D067] SpUNet segment v17 + NH by_moisture ({grp_exp}.{num_exp}) lr={lr}"
)
