...
Derived from experiment/w101/7/moisture_multi/multi-litept-v1m0-flair3d_3.py:
segment v17 + forest + natural_habitat (by_moisture_v3 on-the-fly) + elevation.
"""
...
wandb_run_name = (
    f"[debug/hecate/D067] SpUNet segment v17 + NH by_moisture_v3 ({grp_exp}.{num_exp}) lr={lr}"
)
