...
Derived from experiment/w101/5/climatic_domain_cls/litept-v1m0-flair3d_2.py:
segment v17 + forest + elevation + tile climatic_domain classification.

Requires climatic_domain.npy (--write_climatic_domain_category at preprocess time).
"""
...
wandb_run_name = (
    f"[debug/hecate/D067] SpUNet segment v17+forest+elevation+climatic_domain "
    f"({grp_exp}.{num_exp}) lr={lr}"
)
...
target_keys = semantic_target_keys + ("elevation", "climatic_domain")
