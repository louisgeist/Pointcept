...
natural_habitat uses on-the-fly by_moisture_v3 remap (on-disk labels: preprocess default).
...
# Wandb parameters
wandb_run_name = (
    f"A100 - Flair3D+ LitePT segment v17 + elevation NH by_moisture_v3 ({grp_exp}.{num_exp}) lr={lr}"
)
