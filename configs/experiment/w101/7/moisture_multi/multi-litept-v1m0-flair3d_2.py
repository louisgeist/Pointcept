...
Segment uses label definition v17 (Flair3D-build finer13, 19 classes).
natural_habitat uses on-the-fly by_moisture_v2 remap (on-disk labels: preprocess default).
...
# Wandb parameters
wandb_run_name = (
    f"A100 - Flair3D+ LitePT segment v17 + elevation NH by_moisture_v2 ({grp_exp}.{num_exp}) lr={lr}"
)
wandb_project = "flair3d_moisture_multi"
