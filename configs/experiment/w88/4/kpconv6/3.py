...
wandb_run_name = f"KPConvX {exp_group}.{num_exp}) eff_bs={batch_size*gradient_accumulation_steps} | lr={lr} | grid_size={grid_size} | epoch={epoch} | warmup={warmup_steps} | scheduler=AdamW"
