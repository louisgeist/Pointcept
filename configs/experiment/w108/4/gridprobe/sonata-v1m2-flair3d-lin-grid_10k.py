"""
Sonata-v1m2 grid-search linear probe on Flair3D+ segment (v20) — Jean Zay experiment w108/4/gridprobe (10k).
...
wandb_run_name = f"Sonata-v1m2 grid-probe Flair3D+ segment | iters={total_iters}"
