"""
Sonata-v1m2 grid-search linear probe on Flair3D+ segment (v20) — Jean Zay experiment w108/4/gridprobe (1k, epoch 9).
...
Intended checkpoint (pretrain job 862680, epoch 9):
...
wandb_run_name = f"Sonata-v1m2 grid-probe Flair3D+ segment | iters={total_iters} | ep9"
