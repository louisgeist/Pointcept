"""
Sonata-v1m2 wide grid-search linear probe on Flair3D+ segment (v20) — Jean Zay experiment w108/3/gridprob (20k).
...
wandb_run_name = (
    f"Sonata-v1m2 grid-wide Flair3D+ segment | bs={batch_size} | "
    f"iters={total_iters}"
)
