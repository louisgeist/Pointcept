"""
Sonata-v1m2 wide grid-search linear probe on Flair3D+ segment (v20) — Jean Zay debug w108/3/debug (20 iters, n=42 = 336/8 probes).
...
Grid subsampled to 42 probes (keep every 8-th of the full 336):
...
wandb_run_name = (
    f"Sonata-v1m2 grid-debug n42 | bs={batch_size} | "
    f"iters={total_iters}"
)
...
# Keep every 8-th probe (~336/8 = 42) for cheaper debug.
probes = dict(list(probes.items())[::8])
