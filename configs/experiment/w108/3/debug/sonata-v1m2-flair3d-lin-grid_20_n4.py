"""
Sonata-v1m2 wide grid-search linear probe on Flair3D+ segment (v20) — Jean Zay debug w108/3/debug (2 iters, n=4 = 336/84 probes).
...
# Keep every 84-th probe (~336/84 = 4) for cheaper debug.
probes = dict(list(probes.items())[::84])
