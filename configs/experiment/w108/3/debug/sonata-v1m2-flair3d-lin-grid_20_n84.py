"""
Sonata-v1m2 wide grid-search linear probe on Flair3D+ segment (v20) — Jean Zay debug w108/3/debug (20 iters, n=84 = 336/4 probes).
...
Grid subsampled to 84 probes (keep every 4-th of the full 336):
...
wandb_run_name = (
    f"Sonata-v1m2 grid-debug n84 | bs={batch_size} | "
    f"iters={total_iters}"
)
...
# Keep every 4-th probe (~336/4 = 84) for cheaper debug.
probes = dict(list(probes.items())[::4])
