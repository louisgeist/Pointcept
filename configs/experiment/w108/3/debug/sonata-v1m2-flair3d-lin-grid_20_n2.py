"""
Sonata-v1m2 wide grid-search linear probe on Flair3D+ segment (v20) — Jean Zay debug w108/3/debug (20 iters, n=2 = 336/168 probes).
...
Grid subsampled to 2 probes (keep every 168-th of the full 336):
...
# Sonata pretrain ckpt (job 862680, epoch 9)
...
wandb_run_name = (
    f"Sonata-v1m2 grid-debug n2 | bs={batch_size} | "
    f"iters={total_iters}"
)
...
# Keep every 168-th probe (~336/168 = 2) for cheaper debug.
probes = dict(list(probes.items())[::168])
