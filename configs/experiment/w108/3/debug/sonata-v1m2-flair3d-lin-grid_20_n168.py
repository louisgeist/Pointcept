"""
Sonata-v1m2 wide grid-search linear probe on Flair3D+ segment (v20) — Jean Zay debug w108/3/debug (20 iters, n=168 = 336/2 probes).
...
Grid subsampled to 168 probes (keep every 2-th of the full 336):
...
wandb_run_name = (
    f"Sonata-v1m2 grid-debug n168 | bs={batch_size} | "
    f"iters={total_iters}"
)
...
# Keep every 2-th probe (~336/2 = 168) for cheaper debug.
probes = dict(list(probes.items())[::2])
