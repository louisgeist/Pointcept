"""
Sonata-v1m2 wide grid-search linear probe on Flair3D+ segment (v20) — Jean Zay debug w108/3/debug (20 iters, n=1 = 336/336 probes).
...
Grid subsampled to 1 probes (keep every 336-th of the full 336):
...
wandb_run_name = (
    f"Sonata-v1m2 grid-debug n1 | bs={batch_size} | "
    f"iters={total_iters}"
)
...
# Keep every 336-th probe (~336/336 = 1) for cheaper debug.
probes = dict(list(probes.items())[::336])
