...
weight=5; railroads/transmission lines dropped; scored via APLS at test time).

_2: same as flair3d_default/multi-litept-b-v1m0-flair3d.py with total_iters=100_000.
