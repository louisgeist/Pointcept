...
_1: same as flair3d_default/multi-ptv3-v1m0-flair3d.py with total_iters=100_000,
lr=2e-3 (w108/5/lr2e-3).
...
# Wandb parameters
wandb_run_name = (
    f"ptv3 multi {grp_exp}.{num_exp} iters={total_iters} lr={lr}"
)
