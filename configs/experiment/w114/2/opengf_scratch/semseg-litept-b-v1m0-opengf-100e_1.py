...
semseg-litept-b-v1m0-opengf_1.py (200 epochs): half the schedule (100 epochs).
...
passes (same cadence as the 200-epoch run). Total steps are ~11300
(100 * 1359 train tiles // 12).
...
# Logging parameters
grp_exp = 1
num_exp = 1  # 100 epochs (half of the w114/1 200-epoch run)
...
lr = 1e-3
epoch = 100  # ~11300 iters (1359 train tiles // 12); half of the 200-epoch run
eval_epoch = 10  # one val every 10 dataset passes, same cadence as epoch=200
