...
model = dict(
    ...
    backbone=dict(
        type="PT-v3m1",
        in_channels=4, # RGB + intensity (strength)
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(
                ...
                feat_keys=("color", "strength"), # "normal"),
            ),
        ],
        test_mode=False,
    ),
...
wandb_run_name = f"4.{num_exp}| bs={batch_size}, lr={lr} | patch={patch_size}, epoch={epoch}, mix_prob={mix_prob}, with intensity"