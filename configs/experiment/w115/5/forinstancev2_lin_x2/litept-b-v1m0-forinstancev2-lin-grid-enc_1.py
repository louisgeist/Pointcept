...
identical to that config except `epoch` (600 -> 1200, doubling total
training steps from ~3000 to ~6000; `eval_epoch` left at 10, so eval
count also doubles, 60 -> 120 evals). See the base config's docstring
