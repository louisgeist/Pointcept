...
2x-iteration variant of `configs/experiment/w115/5/forinstancev2_lin/
litept-b-v1m0-forinstancev2-lin-grid-enc-nibio_3.py` — everything below is
identical to that config except `epoch` (3000 -> 6000, doubling total
training steps from 3000 to 6000 since NIBIO's 8 train scenes give 1
step/epoch; `eval_epoch` left at 10, so eval count also doubles,
300 -> 600 evals). See the base config's docstring for the full
