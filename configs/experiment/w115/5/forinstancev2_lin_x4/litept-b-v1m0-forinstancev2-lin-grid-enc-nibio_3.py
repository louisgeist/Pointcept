...
4x-iteration variant of `configs/experiment/w115/5/forinstancev2_lin/
litept-b-v1m0-forinstancev2-lin-grid-enc-nibio_3.py` — everything below is
identical to that config except `epoch` (3000 -> 12000, quadrupling total
training steps from 3000 to 12000 since NIBIO's 8 train scenes give 1
step/epoch; `eval_epoch` left at 10, so eval count also quadruples,
300 -> 1200 evals). See the base config's docstring for the full
epoch-budget derivation.
"""
