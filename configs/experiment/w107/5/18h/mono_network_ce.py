...
Series 2.2: CE only (no Lovasz). Same data/schedule as 2.1.
...
wandb_run_name = (
    ...
    f"{grp_exp}.{num_exp} CE-only lr={lr} iters={total_iters} filtered+strat_val"
)
...
# CE only for network (drop default Lovasz).
