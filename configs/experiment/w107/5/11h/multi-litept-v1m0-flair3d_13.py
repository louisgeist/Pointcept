...
nathab) with stride=(2, 3, 3, 3).

_13: batch_size=20 + GradNormLite pooled nathab (from _11), stride=(2, 3, 3, 3)
(from the earlier stride ablation _2 in w107/3/18h), lr=1e-3.
...
stride=(2, 3, 3, 3), batch_size=20, lr=1e-3, num_gpu=1.
"""
