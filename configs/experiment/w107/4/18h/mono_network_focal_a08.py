...
trained. Loss: FocalLoss (alpha=0.8, favors foreground) + LovaszLoss
(replaces CrossEntropy + Lovasz).
...
# Wandb parameters
wandb_run_name = (
    f"Flair3D+ LitePT mono network roads+railroads focal+lovasz alpha=0.8 "
...
# alpha=0.8 up-weights foreground (network) vs background.
