"""
Sonata-v1m2 pretraining on Flair3D+ (train split only) — VRAM-safety variant B.
...
wandb_run_name = (
    f"Sonata-v1m2 pretrain Flair3D+ | VRAM-safety B (maxsize32768) | bs={batch_size} | "
...
transform = [
    ...
    dict(
        ...
        max_size=32768,  # was 65536: caps per-view point count for VRAM headroom
    ),
    dict(type="ToTensor"),
