"""
LitePT-Small on Flair3D+ multitask: _11 stack (bs=20 + GradNormLite pooled
nathab) with elevation trained/evaluated in meters (no ×0.01 target scale).

_1 (toward_bm): same as w107/5/11h/_11 but removes Collect key_scales and
data.target_scales for elevation. SmoothL1 beta=1.0 preserves the ~1 m Huber
threshold that beta=1e-2 had in the old ×0.01 space. GradNormLite rebalances
the larger elevation loss magnitude.
