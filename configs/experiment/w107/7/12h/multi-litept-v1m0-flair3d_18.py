"""
LitePT-Base on Flair3D+ multitask: GradNormLite pooled nathab, lr=1e-3,
stride=(3, 3, 3, 3), elevation ×0.01 (ELEVATION_TARGET_SCALE).

_18: LitePT-B + batch_size=32 + total_iters=30_000.
...
stride=(3, 3, 3, 3), batch_size=32, total_iters=30_000, lr=1e-3, num_gpu=1.
"""
...
# Data parameters
batch_size = 32 * num_gpu  # total batch size across all gpus
