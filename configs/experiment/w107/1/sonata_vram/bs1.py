...
mitigations are being A/B'd for VRAM headroom; this is variant A: halve
batch_size_per_gpu (2 -> 1), leaving MultiViewGenerator.max_size untouched.
See also: maxsize32768.py (variant B, caps view size instead).
