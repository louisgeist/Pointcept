"""
Test-only: LitePT-v1 multi-task (same as 12.1) with GridSample voxel_repr=centroid.

Evaluates checkpoint from train job 2146226 (config litept-v1m0-flair3d_1).
At test time, each voxel uses mean coord/color/strength instead of the first point.
"""
...
# Checkpoint from litept-v1m0-flair3d_1 (Slurm 2146226)
weight = (
    "/lustre/fswork/projects/rech/unv/usi32yh/Pointcept/logs/slurm/2146226/model/model_best.pth"
)

wandb_run_name = (
    f"Flair3D+ LitePT ({grp_exp}.{num_exp}) | test centroid | ckpt 12.1 / 2146226"
)
