"""
Local smoke-test variant of sonata-v1m2-flair3d-lin-grid.py: D067 manifest
(the only region mirrored on Hecate — see CLAUDE.md "Local vs Jean Zay data
...
model = dict(
    ...
    backbone=dict(
        ...
        # keeps enable_flash=True (matches sonata-v1m2-flair3d-lin.py).
        enable_flash=False,
...
# -----------------------------------------------------------------------------
# Dataset (D067 only — local Hecate mirror)
# -----------------------------------------------------------------------------
