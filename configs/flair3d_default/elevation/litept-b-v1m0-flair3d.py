...
Mono-task Flair3D+ config for point-wise elevation regression (meters). Derived
from multi-litept-b-v1m0-flair3d.py (Base backbone + schedule) with mono-task
wiring aligned to elevation/litept-v1m0-flair3d.py. Inherits only from
default_runtime.
"""
