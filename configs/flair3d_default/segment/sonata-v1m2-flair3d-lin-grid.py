"""
Sonata-v1m2 grid-search linear probing on Flair3D+ semantic segmentation (v20).
...
Adapted from sonata-v1m2-flair3d-lin.py (single-probe version): same frozen
...
wandb_run_name = (
    f"Sonata-v1m2 grid-probe Flair3D+ segment | bs={batch_size} | "
    f"iters={total_iters}"
)
...
# reason ptv3-v1m0-flair3d.py deletes its imported task-config helpers).
