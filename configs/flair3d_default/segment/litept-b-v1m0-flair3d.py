...
Mono-task Flair3D+ config for target ``segment`` (v20). Derived from
multi-litept-b-v1m0-flair3d.py (Base backbone + schedule) with mono-task wiring
aligned to segment/litept-v1m0-flair3d.py. Inherits only from default_runtime.
"""
