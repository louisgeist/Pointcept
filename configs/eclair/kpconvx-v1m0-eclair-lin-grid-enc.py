"""
KPConvX ECLAIR linear probe, encoder-multiscale (`enc_mode=True`).
Frozen Malibu3D multitask backbone; drop_path_rate=0; same probe grid as other ECLAIR lin-grid configs.
"""
