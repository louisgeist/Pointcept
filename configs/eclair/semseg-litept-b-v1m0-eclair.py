"""
LitePT-Base semantic segmentation on ECLAIR (coord + color + strength).

Scratch training template. Inherits only from default_runtime.
"""
...
wandb_run_name = f"ECLAIR LitePT-B semseg ({grp_exp}.{num_exp}) lr={lr}"
...
# -----------------------------------------------------------------------------
# Model — LitePT-Base (same dims as Flair3D+ multi-litept-b)
# -----------------------------------------------------------------------------
model = dict(
