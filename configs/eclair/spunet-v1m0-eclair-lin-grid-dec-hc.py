...
spunet-v1m0-eclair-lin-grid-{enc,dec,enc-dec}.py, job 1052217, Flair3D+ multitask
...
wandb_run_name = (
    f"SpUNet GridProbe ECLAIR {grp_exp}.{num_exp}) decoder hypercolumn {backbone_out_channels}ch, "
