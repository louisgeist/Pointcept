#!/bin/bash
# Jean Zay: sweep PT-v3 pooling model.backbone.stride candidates (VRAM probe)
# via scripts/find_max_pooling_stride.py, with max_size / batch_size_per_gpu
# FIXED.
#
# Usage:
#   sbatch sbatch_find_max_pooling_stride.sh
#
...
#   SOAK_STEPS=0 sbatch sbatch_find_max_pooling_stride.sh
#
...
#SBATCH --job-name=find-max-pooling-stride
