...
# Wide Sonata grid-search linear probe on Flair3D+ segment (1× H100).
# Default weight: pretrain job 862680 / epoch_9.pth
#
# Usage:
#   sbatch scripts/sonata/sbatch_lin_grid_probe_h100.sh
#   sbatch scripts/sonata/sbatch_lin_grid_probe_h100.sh /path/to/epoch_N.pth [exp_name]
#   WEIGHT=... EXP_NAME=... sbatch scripts/sonata/sbatch_lin_grid_probe_h100.sh
#
...
#SBATCH --job-name=sonata_grid_h100
