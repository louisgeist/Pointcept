...
#
# Usage: sbatch scripts/sonata/sbatch_pretrain_resume.sh <exp_name> <config_rel_no_ext> <resume_ckpt_abs_path>
# Example:
#   sbatch scripts/sonata/sbatch_pretrain_resume.sh \
#     sonata_vram_bs1 \
...
#SBATCH --job-name=sonata_pretrain_resume
