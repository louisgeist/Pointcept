...
# Sonata-v1m2 pretrain on ECLAIR (default: 6 nodes × 4 H100 = 24 GPUs).
# Usage: sbatch scripts/sonata/sbatch_pretrain_eclair_h100.sh [exp_name]
#
...
#SBATCH --job-name=sonata_eclair_pretrain

EXP_NAME="${1:-sonata_pretrain_eclair_h100}"
...
#   sbatch scripts/sonata/sbatch_pretrain_eclair_h100.sh sonata_pretrain_eclair_h100 logs/slurm/<OLD_JOB_ID>
...

{
    ...
    echo "Config: eclair/pretrain-sonata-v1m2-eclair"
