#!/usr/bin/env python3
"""Estimate on-disk size of preprocessed Flair3D+ scenes (train/val/test).
...
def format_report(summary: dict) -> str:
    ...
    lines = [
        "Flair3D+ preprocessed disk usage",
