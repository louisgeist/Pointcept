...
python scripts/analyze_flair3d_test_point_voxel_counts.py \
  ...
  --grid_size 0.1 \
  --num_workers 16 \
  --output_dir stats/flair3d/test_point_voxel_counts
...
python scripts/analyze_flair3d_test_point_voxel_counts.py \
  ...
  --splits val,test \
  --grid_size 0.1 \
  --write_manifest data/flair3d_plus/raw/scene_split_manifest.csv \
  --num_workers 16 \
  --output_dir stats/flair3d/test_point_voxel_counts
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output_dir",
        default="stats/flair3d/test_point_voxel_counts",
    )
